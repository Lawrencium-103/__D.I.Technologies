      ...
      <div className="max-w-[1200px] mx-auto px-6 py-12">
        ...
        <ScrollReveal>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <div className="border-2 border-[var(--color-ink)] bg-[var(--color-paper-2)] p-5 col-span-2 lg:col-span-1">
              <div className="font-[var(--font-mono)] text-[0.62rem] uppercase tracking-[0.16em] text-[var(--color-burnt)]">Why it matters</div>
              <p className="text-[0.85rem] text-[var(--color-ink-soft)] mt-2 leading-snug">
                Every download is an SME picking up a compliance-ready tool.
              </p>
            </div>
          </div>
